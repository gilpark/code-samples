<script>
	...
	$:console.log($introProgress, $loginProgress)
</script>



<div id="wrapper">
	<div class="slides fullpage" style="">
		<Swipeable numScreens="3" let:current bind:progress={introProgress}>
			<section class:current={current == 0 && zoomOut} style="top: {100 * $introProgress}%;">
				...
				<div class="content" style="opacity: {1 - Math.abs($introProgress)}">
					<h1>Your thumb.</h1>
			...
			<section class:current={current == 1} style="top: {100 * ($introProgress - 1)}%;">
				...
				<div class="content" style=" opacity: {1 - Math.abs($introProgress - 1)}">
			...
			<section class:current={current == 2} style="top: {100 * ($introProgress - 2)}%;">
				...
				<div class="content" style=" opacity: {1 - Math.abs(introProgress - 2)}">
